 ...
 public class AntLabMain {
    ...
    public void printOutMessage() {
        ...
        String toPrint = 
		  ...
		  Person1 p1 = new Person1("Jeremy Jang");
		  toPrint += p1.toString("jjang49");
		  //Person2 replace P2 with your name
		  //and gburdell with your gt id
		  Person2 p2 = new Person2("Minsung Jung");
		  toPrint += p2.toString("mjung46");
		  //Person3 replace P3 with your name
		  //and gburdell3 with your gt id
		  Person3 p3 = new Person3("Alex Yang");
		  toPrint += p3.toString("ayang76");
                  //Person4 replace P4 with your name
                  //and gburdell4 with your gt id
                  Person4 p4 = new Person4("Alex Yang");
                  toPrint += p4.toString("ayang84");
                  //Person5 replace P4 with your name
                  //and gburdell5 with your gt id
                  Person5 p5 = new Person5("Yuji Takai");
                  toPrint += p5.toString("ytakai3");
